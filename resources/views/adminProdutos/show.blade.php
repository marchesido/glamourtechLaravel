...
@section('content')
    ...
    <a href="{{ route('adminProdutos.edit', $produto->id) }}" class="btn btn-warning">Editar</a>

    <form action="{{ route('adminProdutos.destroy', $produto->id) }}" method="POST" class="d-inline">
        @csrf
        @method('DELETE')
    ...
    <a href="{{ route('adminProdutos.index') }}" class="btn btn-secondary">Voltar</a>
@endsection